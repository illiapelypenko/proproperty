...
// export const propertyFaveslistBackButton = document.querySelector(PROPERTY_FAVESLIST_BACK_BUTTON);
// export const propertyFaveslistContainer = document.querySelector(PROPERTY_FAVESLIST_CONTAINER);
