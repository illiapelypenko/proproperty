...
const PROPERTY_FAVESLIST_CONTAINER = ".property-faveslist-container";
const PROPERTY_FAVESLIST_BACK_BUTTON = ".property-faveslist-back-btn";
const PROPERTY_FAVESLIST = ".property-faveslist";

export const propertyFaveslist = document.querySelector(PROPERTY_FAVESLIST);
export const propertyFaveslistBackButton = document.querySelector(
  PROPERTY_FAVESLIST_BACK_BUTTON
);
export const propertyFaveslistContainer = document.querySelector(
  PROPERTY_FAVESLIST_CONTAINER
);
